                ...
                <AlertDialogContent>
                    ...
                    <AlertDialogMedia className="flex justify-center">
                        <div className="shadow-[0_4px_4px_rgba(0,0,0,0.2)]">
                            <Image src="/stickers/dog2.png" alt="sticker" width={160} height={160}></Image>
                        </div>
                    </AlertDialogMedia>
                    ...
                    <AlertDialogMedia className="grid w-full grid-cols-4">
                        <button type="button" className="hover:translate-y-1 focus:border-white focus:border-2 shadow-[0_4px_4px_rgba(0,0,0,0.2)]">
                            <Image src="/stickers/cherry.png" alt="sticker" width={160} height={160}></Image>
                        </button>
                        <button type="button" className="hover:translate-y-1 focus:border-white focus:border-2 shadow-[0_4px_4px_rgba(0,0,0,0.2)]">
                            <Image src="/stickers/girl.png" alt="sticker" width={160} height={160}></Image>
                        </button>
                        <button type="button" className="hover:translate-y-1 focus:border-white focus:border-2 shadow-[0_4px_4px_rgba(0,0,0,0.2)]">
                            <Image src="/stickers/sakura.png" alt="sticker" width={160} height={160}></Image>
                        </button>
                        <button type="button" className="hover:translate-y-1 focus:border-white focus:border-2 shadow-[0_4px_4px_rgba(0,0,0,0.2)]">
                            <Image src="/stickers/sumire.png" alt="sticker" width={160} height={160}></Image>
                        </button>
                        <button type="button" className="hover:translate-y-1 focus:border-white focus:border-2 shadow-[0_4px_4px_rgba(0,0,0,0.2)]">
                            <Image src="/stickers/star.png" alt="sticker" width={160} height={160}></Image>
                        </button>
                    </AlertDialogMedia>
